...
/*
  <div class="box-header with-border">
    <h3 class="box-title">New Grade Form</h3>
  </div>
  <!-- /.box-header -->
*/
@endphp
  ...
  <!-- form start -->
  <form id="form-teacher-grade-create" role="form" method="POST" action="{{ url('/teacher/grade/create') }}">
    {{ csrf_field() }}
    <div class="box-body">
      <div class="form-group">
        <label for="grade_name">Grade Name</label>
        <input type="text" class="form-control" name="grade[name]" id="grade_name" placeholder="Grade Name" value="" />
      </div>

      <div class="form-group">
        <label for="grade_code">Grade Code</label>
        <input type="text" class="form-control" name="grade[code]" id="grade_code" placeholder="Grade Code" value="" />
      </div>
